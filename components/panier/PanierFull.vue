      ...
      <div class="bulle-wrapper">
        <div class="bulle">
          <div class="message">
            ...
            <div v-if="era == 'now'">
              <span v-if="lang == 'fr'"
                >Waouh! Vous avez beaucoup dépensé! D’après moi, vous avez des
                réserves pour le mois au complet! Il y a des aliments que je
                n’ai jamais vus au village… C’est étonnant!</span
              >
              <span v-else
                >Whoa! You have spent a lot! I think you'll have enough for the
                whole month! There are foods I've never seen in the village,
                it's surprising!</span
              >
            </div>
            <div v-else>
              <span v-if="lang == 'fr'"
              ...
              >
              <span v-else
                >Thanks for your help! That's ${{ max }} well invested! Just
                look at the food you've picked out. I can feel my stomach
                growling already!
              </span>
            </div>
          </div>
